CREATE Procedure [dbo].[UnearnedFunding_Jul2019_Feb2020] @PracticeIDs VARCHAR(MAX)
as
SET NOCOUNT ON	
/*
...
DECLARE @AuthorisedPracticeIDList TABLE
 ...
 where ((YearNo = 2019 and MonthNo in(7,8,9,10,11,12)) or (YearNo = 2020 and Monthno in(1,2)))
