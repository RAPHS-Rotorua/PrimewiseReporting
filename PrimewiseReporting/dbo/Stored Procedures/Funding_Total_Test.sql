CREATE Procedure [dbo].[Funding_Total_Test] @PracticeIDs VARCHAR(MAX), @Month tinyint, @Year smallint
as
SET NOCOUNT ON	
/*
...
@AuthorisedPracticeIDList AS PID
	...
	join FundingTotals_Test as h on h.practiceID = PID.PracticeID
