CREATE PROCEDURE [dbo].[Report_DiseaseBurden]
...
BEGIN
	...
	SELECT 
		...
		,CASE WHEN ISNULL(SD.GrossDALYValue, 0) <> 0 THEN ISNULL(BB.GrossDALYValue, 0) / SD.GrossDALYValue ELSE 0 END  * QuaterlyLINCFundingPool AS QuarterlyPayment
		,(CASE WHEN ISNULL(SD.GrossDALYValue, 0) <> 0 THEN ISNULL(BB.GrossDALYValue, 0) / SD.GrossDALYValue ELSE 0 END  * QuaterlyLINCFundingPool) / 3.0 AS MonthlyPayment
