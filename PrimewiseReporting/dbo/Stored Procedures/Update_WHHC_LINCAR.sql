Create proc [dbo].[Update_WHHC_LINCAR]
as
...
from StaticData.dbo.Stage_DAR_Reporting_WHHC_20240620
where [DAR Last Completed] is not null
union all
Select NHI, Last_Completed, LTC_Status
from StaticData.dbo.Stage_LINC_Reporting_WHHC_20240620
...
where row_num = 1)
	...
	from Stage_LINC_Reporting as i  
		...
		where i.PracticeID = 8 and i.In_Numerator = 0 and p.Numerator = 1;