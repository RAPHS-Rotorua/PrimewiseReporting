...
CREATE Procedure [dbo].[CX_PracticePerformance_Summary_Temp_24_Mar_2017] @PracticeIDs VARCHAR(MAX)
as
SET NOCOUNT ON	
...
@AuthorisedPracticeIDList AS PID
	...
	join CX_Performance_Temp_24_Mar_2017 as h on PID.practiceID = h.PracticeID
