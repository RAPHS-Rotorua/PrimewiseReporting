Create proc [dbo].[Update_TMC_LINCAR]
as
...
from StaticData.dbo.Stage_DAR_Reporting_TMC_20241015 --change this:  Select * from StaticData.dbo.Stage_DAR_Reporting_TMC_20241015
where [DAR Last Completed] is not null
union all
Select NHI, Last_Completed, LTC_Status
from StaticData.dbo.Stage_LINC_Reporting_TMC_20241015  --change this:  Select * from StaticData.dbo.Stage_LINC_Reporting_TMC_20241015
...
where row_num = 1)
	...
	from Stage_LINC_Reporting as i  
		...
		where i.PracticeID = 4 and i.In_Numerator = 0 and p.Numerator = 1;  --change this:  PracticeID