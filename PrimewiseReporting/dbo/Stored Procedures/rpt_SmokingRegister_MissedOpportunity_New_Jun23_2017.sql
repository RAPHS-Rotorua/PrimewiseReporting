...
CREATE Procedure [dbo].[rpt_SmokingRegister_MissedOpportunity_New_Jun23_2017] @PracticeIDs VARCHAR(MAX)
as
SET NOCOUNT ON	
...
@AuthorisedPracticeIDList AS PID
	...
	where h.Numerator_15M_EOQ = 0 and h.LastEvent >= dateadd(day,-10,Cast(GetDate() as Date))