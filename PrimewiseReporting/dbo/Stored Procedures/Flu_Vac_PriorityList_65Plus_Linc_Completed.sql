CREATE Proc [dbo].[Flu_Vac_PriorityList_65Plus_Linc_Completed]  @PracticeIDs VARCHAR(MAX)
as
SET NOCOUNT ON;
...
-
	...
	End >=65,'65 Plus','Less than 65') as '65 Plus', f.Status_Desc, f.IMMDate
from 
...
and p.PracticeID <> 0 and f.Outcome = 'Complete'
) as z
