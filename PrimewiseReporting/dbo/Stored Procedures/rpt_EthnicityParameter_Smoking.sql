...
*/
--rpt_EthnicityParameter_Smoking '30'

CREATE Procedure [dbo].[rpt_EthnicityParameter_Smoking] @PracticeIDs VARCHAR(MAX)
as
...
SELECT DISTINCT 
                      ...
                      CASE Ethnicity1Description WHEN 'NZ Maori' THEN 1 WHEN 'NZ European' THEN 2 WHEN 'Other European' THEN 3 WHEN 'European not further defined' THEN
                       4 WHEN 'Cook Island Maori' THEN 5 WHEN 'Other Pacific Island' THEN 6 WHEN 'Pacific Island not further defined' THEN 7 WHEN 'Samoan' THEN 8 WHEN 'Tokelauan' THEN
...
FROM         Stage_Smoking_Register AS p
	join Patient as pt on p.nhi = pt.NHI and p.PracticeID = pt.PracticeID
