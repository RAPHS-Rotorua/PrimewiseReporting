Create proc [dbo].[Update_TMC_SmokingCessation]
as
...
from StaticData.dbo.Stage_Smoking_Register_TMC_20241015 --change this:  Select * from StaticData.dbo.Stage_Smoking_Register_TMC_20241015
...
from Stage_Smoking_Register as i
	...
	where i.PracticeID = 4 and i.Numerator_15M_EOQ = 0; --change this:  practiceID