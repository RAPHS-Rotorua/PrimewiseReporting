CREATE TABLE [dbo].[LINC_Reporting_TempTest](
	[PracticeID] [int] NULL,
	...
	[Review_Last_Completed] [date] NULL,
	[Next_Planned_Review_Date] [date] NULL,
	[LTCEnrolmentExpiryDate] [date] NULL,
	[In_Denominator] [int] NULL,
	[In_Numerator] [int] NULL,
	[LINC_Status] [varchar](16) NOT NULL,
	[LINC_Status_Sort] [int] NOT NULL,
