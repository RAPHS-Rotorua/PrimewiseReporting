Create view [dbo].[DAR_Performance_Temp_22_May_2017]  --drop view CX_Performance_Temp_24_Mar_2017
as
Select d.PracticeID, 
Case d.PracticeID
	when 1 then 'KMC'
...
/(Select Cast(Sum(Cast(In_Denominator as int)) as decimal(10,2)) from Dar_Reporting_TempTest_19May2017) as RAPHS_Performace
...
(Select Cast(Sum(Cast(In_Numerator as int)) as decimal(10,2)) from [Dar_Reporting_TempTest_19May2017])
/(Select Cast(Sum(Cast(In_Denominator as int)) as decimal(10,2)) from [Dar_Reporting_TempTest_19May2017]) as Performance,
0.90 as National_Target,
Case when
cast((0.90 * (Select Sum(Cast(In_Denominator as int)) from [Dar_Reporting_TempTest_19May2017])) as decimal(10,0)) - 
